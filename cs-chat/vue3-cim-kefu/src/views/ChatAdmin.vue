<template>
  <div style="width:720px;border:1px solid #aaa;padding:16px;margin-top:10px">
    ...
    <button @click="sendMsg">发送给会员member_001</button>
  </div>
</template>
...
let ws = null
const myUid = 'kefu_001'
const targetUid = 'member_001'
