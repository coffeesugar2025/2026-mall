...
public class PolicyClient {
    ...
    public DecisionTable decisionTable() {
        return new DecisionTable(this.policyProperties, this.decisionTableInterface);
    }
    ...
    public GeneralRule generalRule() {
        return new GeneralRule(this.policyProperties, this.generalRuleInterface);
    }
    ...
    public RuleSet ruleSet() {
        return new RuleSet(this.policyProperties, this.ruleSetInterface);
    }
    ...
    public void setpolicyProperties(PolicyProperties policyProperties) {
