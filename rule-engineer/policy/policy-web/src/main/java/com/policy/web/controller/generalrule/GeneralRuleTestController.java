 ...
 */
package com.policy.web.controller.generalrule;
...
@Api(tags = "普通规则测试控制器")
@RestController
@RequestMapping("policy/generalRuleTest")
public class GeneralRuleTestController {
     ...
     * @return result
     */
    @DataPermission(id = "#runTestRequest.id", dataType = Permission.DataType.GENERAL_RULE, operationType = Permission.OperationType.VALID_WORKSPACE)
    @PostMapping("run")
    @ApiOperation("模拟运行")
