...
public class AllPriorityStrategy implements DecisionTableStrategy {
     ...
     */
    @Override
    public List<Object> compute(@NonNull Map<Integer, CollHead.Comparator> collHeadCompareMap, @NonNull Map<Integer, List<Row>> decisionTree, @NonNull Input input, @NonNull PolicyConfiguration configuration) {
