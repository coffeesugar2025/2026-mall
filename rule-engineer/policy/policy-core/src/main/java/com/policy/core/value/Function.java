 ...
 */
package com.policy.core.value;

import com.policy.core.PolicyConfiguration;
import com.policy.core.FunctionExecutor;
import com.policy.core.Input;
import com.policy.core.annotation.Executor;
import com.policy.core.annotation.FailureStrategy;
import com.policy.core.annotation.FunctionCacheable;
import com.policy.core.cache.FunctionCache;
import com.policy.core.cache.KeyGenerator;
import com.policy.common.exception.FunctionException;
...
public class Function implements Value {
     ...
     */
    @Override
    public Object getValue(Input input, PolicyConfiguration configuration) {
        //处理函数入参
