...
import com.policy.core.decisiontable.strategey.DecisionTableStrategy;
import com.policy.core.decisiontable.strategey.DecisionTableStrategyFactory;
import com.policy.common.exception.DecisionTableException;
...
public class DecisionTable extends DataSupport implements JsonParse {
    ...
    @Override
    @Nullable
    public List<Object> execute(@NonNull Input input, @NonNull PolicyConfiguration configuration) {
     ...
     */
    private Map<Integer, CollHead.Comparator> getCollHeadCompare(Input input, PolicyConfiguration configuration) {
