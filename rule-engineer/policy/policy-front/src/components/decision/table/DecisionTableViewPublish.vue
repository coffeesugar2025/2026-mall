    ...
    export default {
        ...
        data() {
            return {
                ...
                runPercentage: 10,
                request: {
                    url: "http://ruleserver.cn/policy/decisionTable/execute",
                    param: [],
                    requestJson: null,
                },
                runData: {
        ...
        methods: {
            ...
            run() {
                ...
                this.$axios.post("/policy/decisionTableTest/run", requestJson).then(res => {
                    let da = res.data;
                    if (da != null) {
            ...
            getDecisionTableView() {
                this.loading = true;
                this.$axios.post("/policy/decisionTable/view", {
                    "id": this.id,
                    "status": 2
                }).then(res => {
                    let da = res.data;
