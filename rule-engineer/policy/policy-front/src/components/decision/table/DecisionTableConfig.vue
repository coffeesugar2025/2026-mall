            ...
            <div>
              ...
              <el-form label-width="70px">
                ...
                <el-form-item label="类型">
                  <el-select v-model="tableData.collConditionHeads[index].leftValue.type" placeholder="请选择数据类型">
                    ...
                    <el-option label="日期" :value="9"
                               @click.native="leftValueTypeChange(index,'DATE')"/>
                  </el-select>
                </el-form-item>
                <el-form-item label="值">
                  ...
                  <el-date-picker
                    v-else-if="tableData.collConditionHeads[index].leftValue.type===9"
                    v-model="tableData.collConditionHeads[index].leftValue.value"
                    :disabled="tableData.collConditionHeads[index].leftValue.type==null"
                    type="datetime"
            ...
            <el-form class="conditionRowFrom">
              <el-form-item class="el-col-7">
                <el-select v-model="scope.row.conditions[index].type"
                  ...
                  <el-option label="日期" :value="9"
                             v-if="isRightTypeSelectView('DATE',tableData.collConditionHeads[index])"
                             @click.native="scope.row.conditions[index].valueType='DATE'"/>
                </el-select>
              </el-form-item>
              ...
              <el-form-item class="el-col-16">
                ...
                <el-date-picker
                  v-else-if="scope.row.conditions[index].type===9"
                  v-model="scope.row.conditions[index].value"
              ...
              <el-form label-width="70px">
                <el-form-item label="类型">
                  <el-select v-model="tableData.collResultHead.type" placeholder="请选择数据类型"
                    ...
                    <el-option label="日期" :value="9"
                               @click.native="tableData.collResultHead.valueType='DATE'"/>
                  </el-select>
                </el-form-item>
                ...
                <el-form-item label="默认类型">
                  <el-select v-model="tableData.collResultHead.defaultAction.type" placeholder="请选择数据类型"
                    ...
                    <el-option label="日期" :value="9"
                               v-if="tableData.collResultHead.valueType==='DATE'"
                               @click.native="tableData.collResultHead.defaultAction.valueType='DATE'"/>
                  </el-select>
                </el-form-item>
                ...
                <el-form-item label="默认值">
                  ...
                  <el-date-picker
                    v-else-if="tableData.collResultHead.defaultAction.type===9"
                    :disabled="tableData.collResultHead.defaultAction.type==null"
                    v-model="tableData.collResultHead.defaultAction.value"
                    type="datetime"
                    value-format="yyyy-MM-dd HH:mm:ss"
            ...
            <el-form class="resultRow">
              <el-form-item class="el-col-7">
                ...
                <el-select v-model="scope.row.result.type"
                  ...
                  <el-option label="日期" :value="9"
                             v-if="tableData.collResultHead.valueType==='DATE'"
                             @click.native="scope.row.result.valueType='DATE'"/>
                </el-select>
              </el-form-item>
              <el-form-item class="el-col-1">
                &nbsp;
...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      this.$axios.post("/policy/decisionTable/updateDecisionTable", {
        "id": this.id,
    ...
    nextStep() {
      ...
      this.$axios.post("/policy/decisionTable/generationRelease", {
        "id": this.id,
        "strategyType": this.strategyType,
        "tableData": this.tableData
      }).then(res => {
    ...
    getDecisionTableConfig() {
      this.loading = true;
      this.$axios.post("/policy/decisionTable/getDecisionTableConfig", {
        "id": this.id
      }).then(res => {
        let da = res.data;
        if (da != null) {
