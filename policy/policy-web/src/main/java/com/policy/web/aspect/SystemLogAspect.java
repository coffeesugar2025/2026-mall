 ...
 */
package com.policy.web.aspect;

import cn.hutool.http.Header;
import cn.hutool.http.useragent.UserAgent;
import cn.hutool.http.useragent.UserAgentUtil;
import com.policy.web.config.Context;
import com.policy.web.listener.event.SystemLogEvent;
import com.policy.web.store.entity.PolicySystemLog;
import com.policy.common.util.HttpServletUtils;
import com.policy.common.util.IPUtils;
import com.policy.web.vo.user.UserData;
import com.alibaba.fastjson.JSON;
import com.policy.common.annotation.SystemLog;
import com.policy.common.interceptor.MDCLogInterceptor;
...
public class SystemLogAspect {
    ...
    private Object before(ProceedingJoinPoint joinPoint, SystemLog systemLog) throws Throwable {
        ...
        //设置日志参数
        PolicySystemLog log = new PolicySystemLog();
        //日志说明
