...
public class ValueResolveImpl implements ValueResolve {
     ...
     */
    @Override
    public Value getValue(Integer type, String valueType, String value, Map<Integer, PolicyElement> engineElementMap) {
        VariableType variableTypeEnum = VariableType.getByType(type);
        switch (variableTypeEnum) {
            case ELEMENT:
                PolicyElement policyElement = engineElementMap.get(Integer.valueOf(value));
                return new Element(policyElement.getId(), policyElement.getCode(), ValueType.getByValue(valueType));
            case VARIABLE:
    ...
    public Value getValue(Integer type, String valueType, String value) {
        ...
        switch (variableTypeEnum) {
            case ELEMENT:
                PolicyElement policyElement = this.policyElementManager.getById(value);
                return new Element(policyElement.getId(), policyElement.getCode(), ValueType.getByValue(valueType));
            case VARIABLE:
                return new Variable(Integer.valueOf(value), ValueType.getByValue(valueType));
            case CONSTANT:
    ...
    public ConfigValue getConfigValue(Value cValue) {
        ...
        if (cValue instanceof Constant) {
            ...
            PolicyElement policyElement = this.policyElementManager.getById(element.getElementId());
            value.setValue(String.valueOf(element.getElementId()));
            value.setValueName(policyElement.getName());
            ...
            PolicyVariable engineVariable = this.policyVariableManager.getById(variable.getVariableId());
    ...
    public ConfigValue getConfigValue(String value, Integer type, String valueType) {
        ...
        if (type.equals(VariableType.ELEMENT.getType())) {
            configValue.setValueName(this.policyElementManager.getById(value).getName());
        } else if (type.equals(VariableType.VARIABLE.getType())) {
            PolicyVariable engineVariable = this.policyVariableManager.getById(value);
     ...
     */
    @Override
    public ConfigValue getConfigValue(String value, Integer type, String valueType, Map<Integer, PolicyVariable> variableMap, Map<Integer, PolicyElement> elementMap) {
        String valueName = value;
        String variableValue = null;
        if (type.equals(VariableType.ELEMENT.getType())) {
            valueName = elementMap.get(Integer.valueOf(value)).getName();
        } else if (type.equals(VariableType.VARIABLE.getType())) {
            PolicyVariable engineVariable = variableMap.get(Integer.valueOf(value));
