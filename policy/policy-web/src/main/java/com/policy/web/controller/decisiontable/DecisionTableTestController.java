 ...
 */
package com.policy.web.controller.decisiontable;
...
@Api(tags = "决策表测试控制器")
@RestController
@RequestMapping("policy/decisionTableTest")
public class DecisionTableTestController {
     ...
     * @return result
     */
    @DataPermission(id = "#runTestRequest.id", dataType = Permission.DataType.DECISION_TABLE, operationType = Permission.OperationType.VALID_WORKSPACE)
    @PostMapping("run")
    @ApiOperation("模拟运行")
