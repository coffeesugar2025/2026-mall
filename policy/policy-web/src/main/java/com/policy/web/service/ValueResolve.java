...
public interface ValueResolve {
     ...
     * @return value
     */
    Value getValue(Integer type, String valueType, String value, Map<Integer, PolicyElement> engineElementMap);
     ...
     * @return ConfigValue
     */
    ConfigValue getConfigValue(String value, Integer type, String valueType, Map<Integer, PolicyVariable> variableMap, Map<Integer, PolicyElement> elementMap);
}
