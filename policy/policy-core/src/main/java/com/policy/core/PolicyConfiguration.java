 ...
 */
package com.policy.core;

import com.policy.core.cache.DefaultFunctionCache;
import com.policy.core.decisiontable.DecisionTable;
import com.policy.core.listener.DefaultExecuteListener;
import com.policy.core.listener.ExecuteListener;
 ...
 */
@Getter
public class PolicyConfiguration implements Closeable {
